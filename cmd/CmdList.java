...
public class CmdList extends FCommand
{
	...
	public void perform()
	{
		...
		if ( ! payForCommand(Conf.econCostList, "pour lister les factions", "pour une liste des factions")) return;
 ...
 */
		...
		for (Faction faction : factionList.subList(start, end))
		{
			if (faction.isNone())
			{
				lines.add(p.txt.parse("<i>Factionless<i> %d en ligne", Factions.i.getNone().getFPlayersWhereOnline(true).size()));
				continue;
			}
